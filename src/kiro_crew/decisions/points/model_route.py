...
def downgrade_landing(
    ...
    *baseline* is taken as given, window unread: it is what this turn would have
    ...
    not this point's call. It is required rather than defaulted, because the caller
    holds the one value that is safe to land on and a default would invent another.
    ``""`` is "leave the model alone".
    """
