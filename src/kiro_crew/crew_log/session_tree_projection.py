...
class SessionTreeProjection:
    ...
    def _replay_tail(
        self, loaded: dict[str, OpenedRecord], loaded_edges: dict[tuple[str, str], EdgeRecord]
    ) -> "tuple[dict[str, OpenedRecord], dict[tuple[str, str], EdgeRecord], bool, bool]":
...
def _load_checkpoint() -> (
    "tuple[dict[str, OpenedRecord], dict[tuple[str, str], EdgeRecord]] | None"
):
