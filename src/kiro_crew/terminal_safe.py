...
__all__ = ["normalize_for_scanning", "safe_terminal_line"]
...
def _is_invisible(character: str) -> bool:
    ...
    return unicodedata.category(character) == "Cf" or character in _INVISIBLE_NON_CF
...
def normalize_for_scanning(value: str) -> str:
    ...
    """
    text = _SCAN_CONTROL_RE.sub("", value)
