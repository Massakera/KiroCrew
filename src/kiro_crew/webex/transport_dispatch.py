            ...
            async with self._queue.lock:
                ...
                if texts and place is not None:
                    ...
                    await self._queue.flip_answering_locked(
                        ...
                        # What the BUBBLE shows, not the raw message: an uncaptioned
                        # attachment was registered under the placeholder, so passing
                        # its empty text here matches nothing and the registry reads the
                        # receipt as unanswered -- leaving an answered attachment on
