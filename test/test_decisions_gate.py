...
class TestBucket:
    ...
    def test_bucket_is_roughly_the_percentage_it_claims(self):
        """Not a distribution test -- a sanity floor that the modulus is not skewed."""
...
class TestScrub:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "aws_AKIAIOSFODNN7EXAMPLE",  # no word boundary -- must still hit
...
class TestStateAndQuestionsReachTheImplementation:
    def test_state_and_questions_pass_through_unchanged(self, install_impl):
        ...
        questions = [
            ...
            Score(id="s", prompt="rate", lo=1, hi=5),
