...
[
  ...
  },
  {
    ...
    "description": "Font size for the conversation, in every session: message text, code, tables, suggestion chips and the composer. The Compact content width grows to match. Sidebar, session list and the rest of the interface are unaffected.",
    "tab": "chat",
    "type": "stepper",
    "occurrence": 1
  },
