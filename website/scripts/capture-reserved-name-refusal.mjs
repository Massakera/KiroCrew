...
const CHAT_SLOT = {
  ...
  messages: [
    { role: 'user', content: 'Summarize what changed in the deploy branch since Monday.', cls: '', ts: '2026-09-22T09:12:00Z' },
    {
      role: 'error',
      content:
        "Rename this crewmate's template: 'default' is reserved for a built-in agent, so the crewmate's own prompt and tools would not run under it. Open the crewmate's Agent Template tab and use 'Save as new template…' under another name -- the crewmate switches to the new copy and keeps its customizations; or use 'Reset my changes' to go back to the shared template.",
      cls: '',
